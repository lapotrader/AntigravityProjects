...
def main():
    ...
    print("Inizio ottimizzazione con filtri Media Mobile...")
    ...
    # Salva in CSV
    res_df.to_csv('supertrend_ma_optimization_results.csv', index=False)
    print("\nTop 15 Combinazioni Ottimizzate per Profitto Netto:")
    print(res_df.head(15).to_string(index=False))
    
    # Ordina per rapporto Profitto / Drawdown (indice di stabilità psicologica)
